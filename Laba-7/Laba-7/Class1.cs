...
namespace Lab7
{
    public class First
    {
        ...
        public static void Execute()
        {
            ...
            string directory = @"C:\Users\Сашок\source\repos\Laba-7";
            ...
            using (StreamReader readFile = new StreamReader(path))
            {
                ...
                {
                    string broadcast = readFile.ReadLine();
            ...
            do
            {
                ...
                Console.WriteLine("8 – Просмотреть лог");
                ...
                if (selector == 7)
                {
                    for (int i = 0; i < table.Count; i++)
                    {
                        int j = i - 1;
                        var temp = table[i];
                        while (j >= 0 && temp.reyting < table[j].reyting)
                        {
                            table[j + 1] = table[j];
                            j--;
                        }
